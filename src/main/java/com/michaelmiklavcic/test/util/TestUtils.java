package com.michaelmiklavcic.test.util;
...
public class TestUtils {
    ...
    /**
     * By default cleans up after test run via runtime shutdown hooks
     */
    ...
    /**
     * Passing cleanup=true cleans up after test run via runtime shutdown hooks
     */
